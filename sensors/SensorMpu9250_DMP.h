...
******************************************************************************/
#ifndef SENSORMPU9250_DMP_H_
#define SENSORMPU9250_DMP_H_
...
extern const signed char defaultOrientation[9];
...
bool MPU9250_DMP_dataReady(void);

inv_error_t MPU9250_DMP_update(unsigned char sensors, MPU9250_DMP* MPU9250_Dmp_Instance);

inv_error_t MPU9250_DMP_updateAccel(MPU9250_DMP* MPU9250_Dmp_Instance);
inv_error_t MPU9250_DMP_updateGyro(MPU9250_DMP* MPU9250_Dmp_Instance);
inv_error_t MPU9250_DMP_updateCompass(MPU9250_DMP* MPU9250_Dmp_Instance);
...
inv_error_t MPU9250_DMP_dmpEnable6Quat(void);
...
inv_error_t MPU9250_DMP_dmpSetInterruptMode(unsigned char mode);

inv_error_t MPU9250_DMP_dmpSetGyroBias(long * bias);

inv_error_t MPU9250_DMP_dmpSetAccelBias(long * bias);
...
float MPU9250_DMP_computeCompassHeading();
