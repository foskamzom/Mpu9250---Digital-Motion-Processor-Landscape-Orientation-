...
inv_error_t inv_register_load_store(
                           ...
                           unsigned char size, unsigned int key);
void inv_init_storage_manager(void);

inv_error_t inv_get_mpl_state_size(unsigned char *size);
inv_error_t inv_load_mpl_states(const unsigned char *data, unsigned char len);
inv_error_t inv_save_mpl_states(unsigned char *data, unsigned char len);
